...
public class TripleReceiveBase extends SynchronizedFederate {

	private SubscribedInteractionFilter _subscribedInteractionFilter = new SubscribedInteractionFilter();
	
	// constructor
	public TripleReceiveBase( String federation_id, String federate_id ) throws Exception {
        ...
        Int1.subscribe( getRTI() );
        _subscribedInteractionFilter.setFedFilters( 
			Int1.get_handle(), 
			SubscribedInteractionFilter.OriginFedFilter.ORIGIN_FILTER_DISABLED, 
			SubscribedInteractionFilter.SourceFedFilter.SOURCE_FILTER_DISABLED 
		);
        Int3.subscribe( getRTI() );
        _subscribedInteractionFilter.setFedFilters( 
			Int3.get_handle(), 
			SubscribedInteractionFilter.OriginFedFilter.ORIGIN_FILTER_DISABLED, 
			SubscribedInteractionFilter.SourceFedFilter.SOURCE_FILTER_DISABLED 
		);
        Int2.subscribe( getRTI() );
        _subscribedInteractionFilter.setFedFilters( 
			Int2.get_handle(), 
			SubscribedInteractionFilter.OriginFedFilter.ORIGIN_FILTER_DISABLED, 
			SubscribedInteractionFilter.SourceFedFilter.SOURCE_FILTER_DISABLED 
       ...
       // constructor
	public TripleReceiveBase(  String[] federationInfo ) throws Exception {
		...
		if(federationInfo.length  > 2) {
			...
			Int1.enableSubscribeLog(
				"Int1",
				"TripleReceive", 
				"NORMAL", 
				loglevel);
			Int3.enableSubscribeLog(
				"Int3",
				"TripleReceive", 
				"NORMAL", 
				loglevel);
			Int2.enableSubscribeLog(
				"Int2",
				"TripleReceive", 
				"NORMAL", 
				loglevel);	
